//This file could do with a refactoring, but it's functional
function DOSWatcher(parameters) {
  parameters = parameters ? parameters : {};
  parameters.condition = () => existsAndVisible(Finder.patient.dosLabels());
  parameters.onFalseToTrue = tagDatesOfService;
  ICA.call(this, parameters)

  function tagDatesOfService(){
